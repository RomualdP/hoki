 ...
 *
 * Provides preset methods for common roles (OWNER, COACH, PLAYER)
 *
 * Usage:
 * ```typescript
 * // Basic player member
...
export class MemberBuilder {
  ...
  /**
   * Configure as OWNER role
   */
  asOwner(): this {
    this.props.role = ClubRole.OWNER;
    this.props.invitedBy = null; // Owners are not invited
    return this;
  }
  ...
  asCoach(): this {
    ...
    this.props.invitedBy = this.props.invitedBy ?? 'owner-1';
    return this;
  }
