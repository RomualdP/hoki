...
describe('Member Entity', () => {
  describe('create()', () => {
    ...
    it('should create member with ASSISTANT_COACH role', () => {
      const member = Member.create({
        id: 'member-1',
        userId: 'user-1',
        clubId: 'club-1',
      ...
      expect(member.role).toBe(ClubRole.ASSISTANT_COACH);
    });
  });
  ...
  describe('Role checks', () => {
    ...
    it('role should be ASSISTANT_COACH for ASSISTANT_COACH role', () => {
      const member = Member.create({
        id: 'member-1',
        userId: 'user-1',
        clubId: 'club-1',
  ...
  describe('Permission checks', () => {
    describe('canManageClubSettings()', () => {
      ...
      it('should return false for ASSISTANT_COACH', () => {
        const member = Member.create({
          id: 'member-1',
          userId: 'user-1',
          clubId: 'club-1',
    ...
    describe('canManageTeams()', () => {
      ...
      it('should return true for ASSISTANT_COACH', () => {
        const member = Member.create({
          id: 'member-1',
          userId: 'user-1',
          clubId: 'club-1',
  ...
  describe('changeRole()', () => {
    it('should successfully change role from PLAYER to ASSISTANT_COACH', () => {
      const member = Member.create({
        id: 'member-1',
        userId: 'user-1',
        clubId: 'club-1',
      ...
      member.changeRole(ClubRole.ASSISTANT_COACH);

      expect(member.role).toBe(ClubRole.ASSISTANT_COACH);
    });

    it('should successfully change role from ASSISTANT_COACH to PLAYER', () => {
      const member = Member.create({
        id: 'member-1',
        userId: 'user-1',
        clubId: 'club-1',
    ...
    it('should throw error when trying to change to COACH role', () => {
      const member = Member.create({
        id: 'member-1',
        userId: 'user-1',
        clubId: 'club-1',
      ...
      expect(() => member.changeRole(ClubRole.COACH)).toThrow(
  ...
  describe('markAsLeft()', () => {
    ...
    it('should throw error when COACH tries to leave', () => {
      const member = Member.create({
        id: 'member-1',
        userId: 'user-1',
        clubId: 'club-1',
